CREATE TABLE public.killbill_account_subscriptions (
    id uuid DEFAULT public.uuid_generate_v4() PRIMARY KEY,    product_id uuid NOT NULL,
...
CREATE TABLE public.killbill_tenants (
    id uuid DEFAULT public.uuid_generate_v4() PRIMARY KEY,    name character varying NOT NULL,
