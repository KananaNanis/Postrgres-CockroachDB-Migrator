...
--
-- Name: lipa_na_mpesa_online_payment_requests; Type: TABLE; Schema: public; Owner: songa_songa
--

CREATE TABLE public.lipa_na_mpesa_online_payment_requests (
...
ALTER TABLE public.lipa_na_mpesa_online_payment_requests OWNER TO songa_songa;

--
-- Name: lipa_na_mpesa_online_payment_response_callbacks; Type: TABLE; Schema: public; Owner: songa_songa
--

CREATE TABLE public.lipa_na_mpesa_online_payment_response_callbacks (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    phone_number character varying NOT NULL,
    amount numeric(15,9) NOT NULL,
    mobile_payment_request_id uuid NOT NULL,
...
ALTER TABLE public.lipa_na_mpesa_online_payment_response_callbacks OWNER TO songa_songa;

--
-- Name: lipa_na_mpesa_online_payment_responses; Type: TABLE; Schema: public; Owner: songa_songa
--

CREATE TABLE public.lipa_na_mpesa_online_payment_responses (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
...
ALTER TABLE public.lipa_na_mpesa_online_payment_responses OWNER TO songa_songa;

--
-- Name: mobile_payment_requests; Type: TABLE; Schema: public; Owner: songa_songa
--

CREATE TABLE public.mobile_payment_requests (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    phone_number character varying NOT NULL,
    amount numeric(15,9) NOT NULL,
...
ALTER TABLE public.mobile_payment_requests OWNER TO songa_songa;

--
-- Name: mobile_payment_responses; Type: TABLE; Schema: public; Owner: songa_songa
--

CREATE TABLE public.mobile_payment_responses (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    phone_number character varying NOT NULL,
    amount numeric(15,9) NOT NULL,
    payment_method character varying NOT NULL,
...
ALTER TABLE public.mobile_payment_responses OWNER TO songa_songa;
...
--
-- Name: sdp_authorization_receipt_callbacks; Type: TABLE; Schema: public; Owner: songa_songa
--

CREATE TABLE public.sdp_authorization_receipt_callbacks (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
...
ALTER TABLE public.sdp_authorization_receipt_callbacks OWNER TO songa_songa;

--
-- Name: sdp_datasync_service_callbacks; Type: TABLE; Schema: public; Owner: songa_songa
--

CREATE TABLE public.sdp_datasync_service_callbacks (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
...
ALTER TABLE public.sdp_datasync_service_callbacks OWNER TO songa_songa;

--
-- Name: sdp_sms_delivery_receipt_callbacks; Type: TABLE; Schema: public; Owner: songa_songa
--

CREATE TABLE public.sdp_sms_delivery_receipt_callbacks (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
...
ALTER TABLE public.sdp_sms_delivery_receipt_callbacks OWNER TO songa_songa;

--
-- Name: sdp_sms_notification_callbacks; Type: TABLE; Schema: public; Owner: songa_songa
--

CREATE TABLE public.sdp_sms_notification_callbacks (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    correlator character varying NOT NULL,
...
ALTER TABLE public.sdp_sms_notification_callbacks OWNER TO songa_songa;

--
-- Name: sdp_subscribe_manage_requests; Type: TABLE; Schema: public; Owner: songa_songa
--

CREATE TABLE public.sdp_subscribe_manage_requests (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    phone_number character varying NOT NULL,
...
ALTER TABLE public.sdp_subscribe_manage_requests OWNER TO songa_songa;

--
-- Name: sdp_subscriptions; Type: TABLE; Schema: public; Owner: songa_songa
--

CREATE TABLE public.sdp_subscriptions (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    userid_id character varying NOT NULL,
    userid_type smallint NOT NULL,
    sp_id character varying NOT NULL,
...
ALTER TABLE public.sdp_subscriptions OWNER TO songa_songa;

--
-- Data for Name: lipa_na_mpesa_online_payment_requests; Type: TABLE DATA; Schema: public; Owner: songa_songa
--

COPY public.lipa_na_mpesa_online_payment_requests (id, business_short_code, password, request_timestamp, transaction_type, amount, party_a, party_b, phone_number, callback_url, account_reference, transaction_desc, status, request_json, external_transaction_id, mobile_payment_request_id, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: lipa_na_mpesa_online_payment_response_callbacks; Type: TABLE DATA; Schema: public; Owner: songa_songa
--

COPY public.lipa_na_mpesa_online_payment_response_callbacks (id, phone_number, amount, mobile_payment_request_id, external_transaction_id, status, response_json, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: lipa_na_mpesa_online_payment_responses; Type: TABLE DATA; Schema: public; Owner: songa_songa
--

COPY public.lipa_na_mpesa_online_payment_responses (id, merchant_request_id, checkout_request_id, response_description, response_code, customer_message, response_json, mobile_payment_response_id, mobile_payment_request_id, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: mobile_payment_requests; Type: TABLE DATA; Schema: public; Owner: songa_songa
--

COPY public.mobile_payment_requests (id, phone_number, amount, payment_method, product_id, external_transaction_id, transaction_description, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: mobile_payment_responses; Type: TABLE DATA; Schema: public; Owner: songa_songa
--

COPY public.mobile_payment_responses (id, phone_number, amount, payment_method, mobile_payment_request_id, external_transaction_id, status, created_at, updated_at) FROM stdin;
\.
...
--
-- Data for Name: sdp_authorization_receipt_callbacks; Type: TABLE DATA; Schema: public; Owner: songa_songa
--

COPY public.sdp_authorization_receipt_callbacks (id, original_transaction_id, capability_type, end_user_identifier, user_cnfm_result, payment_result, created_at, updated_at) FROM stdin;
...
--
-- Data for Name: sdp_datasync_service_callbacks; Type: TABLE DATA; Schema: public; Owner: songa_songa
--

COPY public.sdp_datasync_service_callbacks (id, userid_id, userid_type, sp_id, product_id, product_name, service_id, service_list, update_type, update_time, update_desc, effective_time, expiry_time, transaction_id, order_key, mdspsubexpmode, object_type, trace_unique_id, rent_success, created_at, updated_at) FROM stdin;
...
--
-- Data for Name: sdp_sms_delivery_receipt_callbacks; Type: TABLE DATA; Schema: public; Owner: songa_songa
--

COPY public.sdp_sms_delivery_receipt_callbacks (id, correlator, delivery_status, address, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: sdp_sms_notification_callbacks; Type: TABLE DATA; Schema: public; Owner: songa_songa
--

COPY public.sdp_sms_notification_callbacks (id, correlator, sms_message, sender_address, sms_service_activation_number, date_time, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: sdp_subscribe_manage_requests; Type: TABLE DATA; Schema: public; Owner: songa_songa
--

COPY public.sdp_subscribe_manage_requests (id, phone_number, request_json, created_at, updated_at, product_id, status, amount, payment_method, account_id, payment_id, payment_transaction_id, payment_external_key, transaction_description) FROM stdin;
...
--
-- Data for Name: sdp_subscriptions; Type: TABLE DATA; Schema: public; Owner: songa_songa
--

COPY public.sdp_subscriptions (id, userid_id, userid_type, sp_id, product_id, product_name, service_id, service_list, update_type, update_time, update_desc, effective_time, expiry_time, transaction_id, order_key, mdspsubexpmode, object_type, trace_unique_id, rent_success, created_at, updated_at) FROM stdin;
\.


--
-- Name: lipa_na_mpesa_online_payment_requests lipa_na_mpesa_online_payment_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: songa_songa
--

ALTER TABLE ONLY public.lipa_na_mpesa_online_payment_requests
    ADD CONSTRAINT lipa_na_mpesa_online_payment_requests_pkey PRIMARY KEY (id);


--
-- Name: lipa_na_mpesa_online_payment_response_callbacks lipa_na_mpesa_online_payment_response_callbacks_pkey; Type: CONSTRAINT; Schema: public; Owner: songa_songa
--

ALTER TABLE ONLY public.lipa_na_mpesa_online_payment_response_callbacks
    ADD CONSTRAINT lipa_na_mpesa_online_payment_response_callbacks_pkey PRIMARY KEY (id);


--
-- Name: lipa_na_mpesa_online_payment_responses lipa_na_mpesa_online_payment_responses_pkey; Type: CONSTRAINT; Schema: public; Owner: songa_songa
--

ALTER TABLE ONLY public.lipa_na_mpesa_online_payment_responses
    ADD CONSTRAINT lipa_na_mpesa_online_payment_responses_pkey PRIMARY KEY (id);


--
-- Name: mobile_payment_requests mobile_payment_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: songa_songa
--

ALTER TABLE ONLY public.mobile_payment_requests
    ADD CONSTRAINT mobile_payment_requests_pkey PRIMARY KEY (id);


--
-- Name: mobile_payment_responses mobile_payment_responses_pkey; Type: CONSTRAINT; Schema: public; Owner: songa_songa
--

ALTER TABLE ONLY public.mobile_payment_responses
...
--
-- Name: sdp_authorization_receipt_callbacks sdp_authorization_receipt_callbacks_pkey; Type: CONSTRAINT; Schema: public; Owner: songa_songa
--

ALTER TABLE ONLY public.sdp_authorization_receipt_callbacks
    ADD CONSTRAINT sdp_authorization_receipt_callbacks_pkey PRIMARY KEY (id);


--
-- Name: sdp_datasync_service_callbacks sdp_datasync_service_callbacks_pkey; Type: CONSTRAINT; Schema: public; Owner: songa_songa
--

ALTER TABLE ONLY public.sdp_datasync_service_callbacks
    ADD CONSTRAINT sdp_datasync_service_callbacks_pkey PRIMARY KEY (id);


--
-- Name: sdp_sms_delivery_receipt_callbacks sdp_sms_delivery_receipt_callbacks_pkey; Type: CONSTRAINT; Schema: public; Owner: songa_songa
--

ALTER TABLE ONLY public.sdp_sms_delivery_receipt_callbacks
    ADD CONSTRAINT sdp_sms_delivery_receipt_callbacks_pkey PRIMARY KEY (id);


--
-- Name: sdp_sms_notification_callbacks sdp_sms_notification_callbacks_pkey; Type: CONSTRAINT; Schema: public; Owner: songa_songa
--

ALTER TABLE ONLY public.sdp_sms_notification_callbacks
    ADD CONSTRAINT sdp_sms_notification_callbacks_pkey PRIMARY KEY (id);


--
-- Name: sdp_subscribe_manage_requests sdp_subscribe_manage_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: songa_songa
--

ALTER TABLE ONLY public.sdp_subscribe_manage_requests
    ADD CONSTRAINT sdp_subscribe_manage_requests_pkey PRIMARY KEY (id);


--
-- Name: sdp_subscriptions sdp_subscriptions_pkey; Type: CONSTRAINT; Schema: public; Owner: songa_songa
--

ALTER TABLE ONLY public.sdp_subscriptions
    ADD CONSTRAINT sdp_subscriptions_pkey PRIMARY KEY (id);


--
-- Name: address_idx; Type: INDEX; Schema: public; Owner: songa_songa
--

CREATE INDEX address_idx ON public.sdp_sms_delivery_receipt_callbacks USING btree (address);


--
-- Name: correlator_sms_delivery_idx; Type: INDEX; Schema: public; Owner: songa_songa
--

CREATE INDEX correlator_sms_delivery_idx ON public.sdp_sms_delivery_receipt_callbacks USING btree (correlator);


--
-- Name: correlator_sms_notification_idx; Type: INDEX; Schema: public; Owner: songa_songa
--

CREATE INDEX correlator_sms_notification_idx ON public.sdp_sms_notification_callbacks USING btree (correlator);


--
-- Name: original_transaction_id_idx; Type: INDEX; Schema: public; Owner: songa_songa
--

CREATE INDEX original_transaction_id_idx ON public.sdp_authorization_receipt_callbacks USING btree (original_transaction_id);


--
-- Name: phone_number_idx; Type: INDEX; Schema: public; Owner: songa_songa
--

CREATE INDEX phone_number_idx ON public.sdp_subscribe_manage_requests USING btree (phone_number);
...
--
-- Name: sender_address_idx; Type: INDEX; Schema: public; Owner: songa_songa
--

CREATE INDEX sender_address_idx ON public.sdp_sms_notification_callbacks USING btree (sender_address);


--
-- Name: transaction_id_idx; Type: INDEX; Schema: public; Owner: songa_songa
--

CREATE INDEX transaction_id_idx ON public.sdp_datasync_service_callbacks USING btree (transaction_id);


--
-- Name: transaction_id_sdp_subscriptions_idx; Type: INDEX; Schema: public; Owner: songa_songa
--

CREATE INDEX transaction_id_sdp_subscriptions_idx ON public.sdp_subscriptions USING btree (transaction_id);


--
-- Name: userid_id_idx; Type: INDEX; Schema: public; Owner: songa_songa
--

CREATE INDEX userid_id_idx ON public.sdp_datasync_service_callbacks USING btree (userid_id);


--
-- Name: userid_id_sdp_subscriptions_idx; Type: INDEX; Schema: public; Owner: songa_songa
--

CREATE INDEX userid_id_sdp_subscriptions_idx ON public.sdp_subscriptions USING btree (userid_id);
